...
(function (window, undefined) {
    ...
    var _modules = {
        Mallan:{ rely:[] },
        'animation.fade':{ rely:[ 'dom.selector', 'dom.element', 'dom.element.style', 'events.customevent', 'lang.array', 'animation.animate' ] },
        'animation.slide':{ rely:[ 'dom.selector', 'dom.element', 'dom.element.style', 'events.customevent', 'lang.array', 'animation.animate' ] },
        'animation.animate':{ rely:[ 'dom.selector', 'dom.element', 'dom.element.style', 'events.customevent', 'lang.array' ] },
        'util.getscript':{ rely:[] },
        'util.getcss':{ rely:[] },
        'util.cookie':{ rely:[] },
        'util.listitem':{ rely:[] },
        ...
        'events.keycode':{ rely:[] },
        'events.hover':{ rely:[ 'dom.selector', 'dom.element', 'events.keycode', 'events.event', 'events.eventbind' ] },
        'events.eventbind':{ rely:[ 'dom.selector', 'dom.element', 'events.keycode', 'events.event' ] },
        ...
        'plugin.calendar':{ rely:[ 'util.date', 'events.customevent', 'dom.selector', 'dom.element','dom.element.style','dom.element.node','dom.element.offset','events.event', 'dom.element.create','events.eventbind','util.page' ] },
