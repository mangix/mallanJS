...
(function(window, undefined) {
	...
	var _modules = {
		...
		'plugin.treeview' : {
			rely : ['dom.selector', 'dom.element', 'dom.element.style', 'events.keycode', 'events.event', 'events.eventbind', 'events.customevent', 'util.loader', 'lang.array']
		},
		'plugin.tabview' : {
			rely : ['dom.selector', 'dom.element', 'dom.element.style', 'events.customevent', 'events.keycode', 'events.event', 'events.eventbind']
		},
