...
(function (window, undefined) {
    ...
    var _modules = {
        ...
        'plugin.calendar':{ rely:[ 'util.date', 'events.customevent', 'dom.selector', 'dom.element','dom.element.style','dom.element.node','dom.element.offset','events.event', 'dom.element.create','events.eventbind' ] },
